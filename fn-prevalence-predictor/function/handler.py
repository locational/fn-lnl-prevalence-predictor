...
def geojson_encoder_tmp(dataframe, fields=[], layer_names=[], lng='lng', lat='lat'):
    '''
...
def run_function(params: dict):
    ...
    if layer_names is not None:
        ...
        covs_request = geojson_encoder_tmp(input_data, fields=['id'], layer_names=layer_names)
        ...
        input_data = pd.merge(input_data, covs_data, how='left', left_on=['id'], right_on=['id'])
